...
public class DeviceUtils {
    ...
    /*public int getStatusBarHeight() {
        int result = 0;
        int resourceId = BankManagerApplication.getContext().getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            result = BankManagerApplication.getContext().getResources().getDimensionPixelSize(resourceId);
        }
        return result;
    }*/

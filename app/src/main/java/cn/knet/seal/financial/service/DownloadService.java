package cn.knet.seal.financial.service;
...
import cn.knet.seal.financial.ui.activity.MainActivity;
import cn.knet.seal.financial.util.DeviceUtils;
import cn.knet.seal.financial.util.ICallbackResult;
...
public class DownloadService extends Service {
	...
	private String saveFileName = KnetConstants.getBaseCacheDir(false);
	...
	private Runnable mdownApkRunnable = new Runnable() {
		@Override
		public void run() {
			File file = new File(KnetConstants.getBaseCacheDir(false));
			if (!file.exists()) {
				file.mkdirs();
			}
			...
			try {
				...
				EventBus.getDefault().post(new StringMsgEvents(mContext.getString(R.string.down_err)));
				mNotificationManager.cancel(NOTIFY_ID);
				e.printStackTrace();
			}
		}
